...
public abstract class BaseCommand implements CommandExecutor {
     ...
     */
    public final static String PERMISSION_BASE = "hatena.chatdecorator";
    ...
    protected String getCommandSourceUuid(CommandSource src) {
        if (src instanceof Player) {
            ...
            return UserManager.IDENT_SERVER_CONSOLE;
        } else {
            return UserManager.IDENT_UNKNOWN;
        }
    }
    ...
    public void registerSelf() {
        Sponge.getCommandManager().register(ChatDecorator.getInstance(), buildSelf(), alias);
    }
}
